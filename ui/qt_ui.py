...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.getCurrentPushButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Get only programme on current tab</p></body></html>"))
        ...
        for p_i, prog in enumerate(self.progs):
            ...
            prog["jsXAxisComboBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Behaviour on the X axis</p><p>Pitchbend: send bend signal</p><p>CC 1: send CC signal on channel from <i>Left</i> field </p><p>CC 2: send CC signal on channels from either <i>Left</i> or <i>Right</i> field</p></body></html>"))
            ...
            prog["jsYAxisComboBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Behaviour on the Y axis</p><p>Pitchbend: send bend signal</p><p>CC 1: send CC signal on channel from <i>Up</i> field </p><p>CC 2: send CC signal on channels from either <i>Up</i> or <i>Down</i> field</p></body></html>"))
            ...
            prog["timeDivComboBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Arpeggiator time signature</p></body></html>"))
            ...
            prog["swingComboBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Arpeggiator time shifting</p></body></html>"))
            ...
            prog["modeComboBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Arpeggiator mode</p></body></html>"))
            ...
            prog["clockComboBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Arpeggiator clock synchronization mode</p></body></html>"))
            prog["latchCheckBox"].setText(_translate("MainWindow", "Latch"))
            prog["latchCheckBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Arpeggiator latch: keep the arp going</p></body></html>"))
            ...
            for b_i, bank in enumerate(prog["banks"]):
                ...
                for pa_i, pad in enumerate(bank["pads"]):
                    ...
                    pad["padNoteComboBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Pad note</p></body></html>"))
                    pad["padNoteSpinBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Pad octave</p></body></html>"))
                    pad["padCCSpinBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Pad CC value</p></body></html>"))
                    pad["padPCSpinBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Pad PC value</p></body></html>"))
                    pad["padTypeComboBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Pad behaviour</p></body></html>"))
            for knob in prog["knobs"]:
                knob["knobCCSpinBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Knob CC value</p></body></html>"))
                knob["knobMinSpinBox"].setToolTip(_translate("MainWindow", "<html><head/><body><p>Knob minimum value</p></body></html>"))
